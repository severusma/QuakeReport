    ...
    public static List<Earthquake> extractEarthquakes(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < feature.length(); i++) {
                JSONObject eq = feature.getJSONObject(i);
                JSONObject eqfeature = eq.getJSONObject("properties");
                double mag = eqfeature.getDouble("mag");
                String place = eqfeature.getString("place");

                long timeInMilliseconds = eqfeature.getLong("time");

                // Extract the value for the key called "url"
                String url = eqfeature.getString("url");
